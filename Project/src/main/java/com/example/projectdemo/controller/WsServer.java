...
@Component
@ServerEndpoint(value = "/subject", configurator = HttpSessionConfigurator.class)
public class WsServer {
    ...
    public void onMessage(String message) {
        System.out.println("来自Ws的消息:" + message);
        //群发消息
        if (this.subjectService == null) {
            this.subjectService = SpringContextUtil.getBean("subjectService");
        }
        String str = gson.toJson(subjectService.selectStudentByTeacherId(message));
